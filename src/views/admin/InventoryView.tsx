  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader
        ...
        description={
          initialTab === 'low-stock'
            ? 'Products at or below their buffer level, so they can be produced before they run out.'
            : activeTab === 'movements'
            ? 'Every movement in and out of the central warehouse, in order.'
            : 'Live warehouse stock and its valuation.'
        }
        actions={
          <>
